    ...
    def __init__(
        ...
        *,
        ...
        if self.is_pairwise:
            ...
            from shadow_antibiogram.controllers.CoTestAnalyzerAggregated import CoTestAnalyzer as CoTestAnalyzerAggregated
            ...
            from shadow_antibiogram.controllers.CoTestAnalyzer import CoTestAnalyzer
