...
from shadow_antibiogram.mappers.antibiotic_to_grams import ABX_TARGET_MAP, CATALOG
...
def merge_antibiotic_data(
    ...
    from shadow_antibiogram.mappers.synonym_mapping import synonym_mapping
